...
import com.example.jsonservices.MenuJSON;
...
public class MenuActivity extends Activity {
	...
	private MenuAdapter adapter; // 主体listview的baseadapter
	private SimpleAdapter dqadapter; // 地区adapter
	private List<Meal> list1 = null;
...
//		Button5 = (Button) findViewById(R.id.dcbutton5);
		...
		MyListView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent1.setClass(MenuActivity.this, JindianActivity.class);
...
//		});
		...
		// Ignore tag
		Button4.setText("Cart：" + GoodsDBManager1.totalcount());
		...
		Button4.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent Intent1 = new Intent();
				Intent1.setClass(MenuActivity.this, OrderActivity.class);
...
//		});
	...
	private void binddq() {
		try {
			...
			dqlist.add(item);
			dqadapter = new SimpleAdapter(MenuActivity.this, dqlist,
	...
	private Handler Handler1 = new Handler() {
		public void handleMessage(Message msg) {
			try {
				...
				if (list1.size() > 0) {
					bindlist(list1);
					adapter = new MenuAdapter(MenuActivity.this, list1);
					adapter.addlist(list1);
					MyListView1.setAdapter(adapter);
					ProgressDialog1.dismiss();
				} else {
					ProgressDialog1.dismiss();
					Toast.makeText(MenuActivity.this, "Sorry, this restaurant doesn't provide meals currently...", 1)
							.show();
				}
...
//				adapter.addlist(list1);
	...
	public void bindlist(List<Meal> list) {
		for (Meal goodss : list) {
			HashMap<String, Object> item = new HashMap<String, Object>();
	...
	public List<Meal> loaddata(int page) {

		try {
			
//			String url = DBhelper.localHostIp + "servlet/JsonAction?action_flag=Goods&res_id=" + resId;
			String url = localhost() + "servlet/JsonAction?action_flag=Goods&res_id=" + resId;
			goodss = MenuJSON.getjsonlastgoods(url);

		} catch (Exception e) {
			e.printStackTrace();

			ProgressDialog1.dismiss();
			goodss = new ArrayList<Meal>();
//			Toast.makeText(DiancaiActivity.this, "全部显示完毕！", 1).show();
	...
	protected Dialog onCreateDialog(int id) {
		...
		RecognizerDialog recognizerDialog = new RecognizerDialog(
				MenuActivity.this, "appid=5132fe14");// 这里应该写从科大讯飞申请到的appid
