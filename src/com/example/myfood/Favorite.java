...
public class Favorite extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dinglikeDBManager = new FavoriteDBManager(Favorite.this);
		...
		public void handleMessage(Message msg) {
			try {
				if (loaddata().size() > 0) {
					list1 = loaddata();
					bindlist(list1);
					adapter = new SimpleAdapter(Favorite.this,
					...
					Toast.makeText(Favorite.this, "Waiting for Development", 1)
							.show();
				}
				...
				e.printStackTrace();
				ProgressDialog1.dismiss();
				Toast.makeText(Favorite.this, "Weak network connection，please wait...", 1)
						.show();
				// neterror();//网络重试
			}
		}
	...
	private List<Meal> loaddata() {
		...
		try {
			goods = MenuJSON.getjsonlastgoods(
