...
public class UserJSON {
	 ...
	 * @throws Exception
	 */
	public static List<User> getjsonlastusers(String url)
			throws Exception {
		try {
			String path = url;
	...
	private static List<User> parsejson(InputStream jsonStream)
			throws Exception {
		...
		try {
			...
			for (int i = 0; i < jsonarray.length(); i++) {
				...
				list.add(new User(_id, _group_id, _user_name, _password,
