...
public class RestaurantJSON {
	...
	public static List<Restaurant> getJsonCategory(String url) throws Exception {
	...
	private static List<Restaurant> parseResponse(String response) {
		...
		try {
			...
			for (int i = 0; i < jsonarray.length(); i++) {
				...
				list.add(new Restaurant(id, channel_id, title, call_index,
	...
	public static List<Restaurant> getjsonlastcategory(String url)
			throws Exception {
		try {
			String path = url;
	...
	private static List<Restaurant> parsejson(
